...
class SubNewPostNotificationType implements NotificationTypeInterface
{
    public const NAME = 'sub_new_post';
    ...
    public function getTokenDefinitions(): array
    {
        return [
            ...
            $this->factory->create(TextTokenDefinition::class, 'post_title', 'post_title'),
        ];
    }
}
